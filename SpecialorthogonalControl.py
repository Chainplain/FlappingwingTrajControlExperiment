...
class SO_3_controller:
    ...
    def Generate_control_signal(self, rotation_matrix_current, angular_velocity_current,\
        ...
        # print('rotation_matrix_current: ' + str(rotation_matrix_current) +
        #       'angular_velocity_current: '+ str(angular_velocity_current))
        ...
        # print('self.error_A', self.error_A)
        ...
        # print('self.a_desire',self.a_desire)
        ...
        # print(' self. J_estimated:',  self. J_estimated)
        ...
        # print('u_1st:' + str(u_1st) + 'u_2nd:' + str(u_2nd) + 'u_5th:' + str(u_5th) + 'u_6th:' + str(u_6th) )
