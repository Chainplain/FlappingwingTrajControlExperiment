clear all;
load('DESKTOP-4J3FS1P_2023_08_19_04_43_30FlapperInQualisys.mat')
DarkRed = [0.7,0.2,0.2];
...
plot(record_time_stamp(Cut),record_p(Cut,1) ,"-",'LineWidth',LineWidth,'Color',LighGrayRed * 0.7);
plot(record_time_stamp(Cut),record_p(Cut,2) ,"-",'LineWidth',LineWidth,'Color',LighGrayGreen * 0.7);
plot(record_time_stamp(Cut),record_p(Cut,3) ,"-",'LineWidth',LineWidth,'Color',LighGrayBlue* 0.7);
legend('X','Y','Z');
...
plot(record_time_stamp(Cut),record_Observer_v(Cut,1) ,"-",'LineWidth',LineWidth,'Color',LighGrayRed * 0.7);
plot(record_time_stamp(Cut),record_Observer_v(Cut,2) ,"-",'LineWidth',LineWidth,'Color',LighGrayGreen * 0.7);
plot(record_time_stamp(Cut),record_Observer_v(Cut,3) ,"-",'LineWidth',LineWidth,'Color',LighGrayBlue* 0.7);
